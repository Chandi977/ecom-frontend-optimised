...
export async function getServerSideProps(context) {
  ...
  const filterPayload = {
    category: PAPER_BAG_CATEGORY_ID,
...
const BoppTape = ({
  ...
  const [gusset, setGusset] = useState([0, 300]);
  ...
  const buildFilterPayload = useCallback(
    ...
    [baseFilter, breadth, flags.size, flap, gusset, seelctedCategories, width],
  );
  ...
  const handleGusset = (event, newValue) => {
    setGusset(newValue);
  };
          ...
          >
            <div className="mt-2 d-flex flex-column">
              <p className={"catalogpath"}>
                ...
                <span className={"tw-no-underline"}>Paper Bags</span>
              </p>
              <div
            ...
            <div className="row mt-4 d-flex" style={{ position: "relative" }}>
              ...
              >
                <div className={"col-12 p-0 m-0" + "filterslayout"}>
                  <div
                    className="w-100"
                    style={{ height: "520px", border: "1px solid #E6E6E6" }}
                  >
                    <div
                      className="row m-0"
                    ...
                    >
                      <div className="col">
                        ...
                        <Slider
                          ...
                          max={300}
                        />
                        <p className="mb-0 mt-1">Gusset (mm)</p>
                        <div className="mt-2 d-flex flex-row align-items-center justify-content-between">
                          <p
                            className="mb-0 px-2 bg-light"
                            style={{
