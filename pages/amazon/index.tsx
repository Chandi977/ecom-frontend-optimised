...
const AMAZON_BRAND_ID = "69268af9d53f3a772c6bccc2";
  ...
  const renderCategoryFilter = () => (
    ...
    >
      <div className="row m-0" style={{ paddingLeft: 3, paddingRight: 3 }}>
        <div className="col">
          <p className="mb-0 mt-3" style={{ fontWeight: "700", color: "#333333" }}>
            Filter by Catagory
          </p>
          ...
          >
            <div className="mt-2 d-flex flex-column">
              <p className="page-catalogpath">
                ...
                <span className="tw-no-underline">Amazon</span>
              </p>
              <div
