    ...
    >
      ...
      <div className="banner-content">
        <div className="d-flex flex-column justify-content-start">
          <h1 className="banner-corrugated-header">PAPER TAPES</h1>
          <p className="banner-corrugated-subtext">
            Buy paper tapes online for eco-friendly carton sealing. Premium kraft adhesive tapes offering high-strength, tamper-evident security with sustainable packaging.
          </p>
        </div>
      </div>
      <style jsx>{`
