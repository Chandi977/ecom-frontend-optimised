    ...
    >
      ...
      <div className="banner-content">
        <div className="d-flex flex-column justify-content-start">
          <h1 className="banner-corrugated-header">CHROMO LABELS</h1>
          <p className="banner-corrugated-subtext">
            Buy chromo labels online in premium self-adhesive paper rolls. Designed for high-quality barcode printing, shipping tags, and custom retail packaging with superior adhesion.
          </p>
        </div>
      </div>
      <style jsx>{`
