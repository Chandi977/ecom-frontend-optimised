    ...
    >
      ...
      <div className="banner-content">
        <div className="d-flex flex-column justify-content-start">
          <h1 className="banner-corrugated-header">DIRECT THERMAL LABELS</h1>
          <p className="banner-corrugated-subtext">
            Buy direct thermal labels online for quick and clean printing. Premium heat-sensitive labels on rolls ideal for shipping barcodes, weight scale labeling, and warehouse tracking.
          </p>
        </div>
      </div>
      <style jsx>{`
