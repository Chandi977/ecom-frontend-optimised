      ...
      <div className="banner-content">
        <div className="d-flex flex-column justify-content-start">
          ...
          <p className="banner-corrugated-subtext">
            Buy carry handle tapes online for comfortable packaging transport. Premium adhesive handle tape solutions designed to carry heavy beverage packs and bulky boxes easily.
          </p>
        </div>
      </div>
      <style jsx>{`
