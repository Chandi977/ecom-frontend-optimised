  ...
  return (
    ...
    >
      <div className="w-100 h-100">
        <img
          src={cdn("/BannerSpeciality.jpg")}
          alt="Void Tapes Banner"
      ...
      <div className="banner-content">
        <div className="d-flex flex-column justify-content-start">
          <h1 className="banner-corrugated-header">VOID TAPES</h1>
          <p className="banner-corrugated-subtext">
            Buy void tapes online for high-security packaging. Premium tamper-evident tape solutions designed to secure transit shipments and prevent theft with clear indicators.
          </p>
        </div>
      </div>
      <style jsx>{`
