    ...
    >
      ...
      <div className="banner-content">
        <div className="d-flex flex-column justify-content-start">
          <h1 className="banner-corrugated-header">CARRY BAGS</h1>
          <p className="banner-corrugated-subtext">
            Buy carry bags online in versatile shapes and sizes. Durable, premium-quality bags designed for convenient shopping, custom retail branding, and daily utility.
          </p>
        </div>
      </div>
      <style jsx>{`
