    ...
    >
      ...
      <div className="banner-content">
        <div className="d-flex flex-column justify-content-start">
          <h1 className="banner-corrugated-header">PACKPRO™</h1>
          <p className="banner-corrugated-subtext">
            Buy Packpro™ online for industrial-grade sealing. Premium-strength packaging tape designed to secure heavy-duty corrugated cartons and packages for safe shipment.
          </p>
        </div>
      </div>
      <style jsx>{`
