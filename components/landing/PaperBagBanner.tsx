    ...
    >
      ...
      <div className="banner-content">
        <div className="d-flex flex-column justify-content-start">
          <h1 className="banner-corrugated-header">PAPER BAGS</h1>
          <p className="banner-corrugated-subtext">
            Buy paper bags online for sustainable and elegant packaging. Premium kraft bags with strong handles, ideal for eco-friendly shopping, boutique retail, and gift branding.
          </p>
        </div>
      </div>
      <style jsx>{`
