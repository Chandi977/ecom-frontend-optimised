      ...
      <div className="banner-content">
        <div className="d-flex flex-column justify-content-start">
          <h1 className="banner-corrugated-header">
            Buy Rollabel™ Labels Online – <br />
            Direct Thermal &amp; Chromo Labels
          </h1>
          <p className="banner-corrugated-subtext">
            Buy Rollabel™ labels online for shipping, retail, inventory and
            product identification. Explore direct thermal and chromo label
            rolls available in multiple sizes and pack quantities.
          </p>
        </div>
      </div>
      <style jsx>{`
