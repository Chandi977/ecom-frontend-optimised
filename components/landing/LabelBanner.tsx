    ...
    >
      ...
      <div className="banner-content">
        <div className="d-flex flex-column justify-content-start">
          <h1 className="banner-corrugated-header">ROLLABEL™</h1>
          <p className="banner-corrugated-subtext">
            Buy Rollabel™ online for premium product branding. Versatile, high-adhesion self-adhesive label rolls designed for custom packaging and seamless business applications.
          </p>
        </div>
      </div>
      <style jsx>{`
